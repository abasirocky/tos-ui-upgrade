<template>
  <div>
    ...
    >
      <div class="gutter-b pt-2 pl-0 pr-0" style="max-height: 65vh;">
        ...
        <div class="d-flex mb-3">
          ...
          >
          <span
            :inner-html.prop="model.startOperationDate | formatDateWithTime"
            class="flex-root text-dark-90 font-size-h7"
          ></span>
        </div>
        <div class="d-flex mb-3">
          ...
          >
          <span
            :inner-html.prop="model.endOperationDate | formatDateWithTime"
            class="flex-root text-dark-90 font-size-h7"
          ></span>
        </div>
        <div class="d-flex mb-3">
    ...
    <b-modal
      ...
      @hide="hideSOFModal"
    >
      <VoyageSOF :voyageId="model.voyageId"></VoyageSOF>
    </b-modal>
  </div>
</template>
