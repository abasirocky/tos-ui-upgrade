...
export default {
  ...
  data() {
    return {
      ...
      startBollard: { text: "", value: "" },
      endBollard: { text: "", value: "" },
      berthSide: { text: "", value: "" }, 
    };
  },
  validations: {
    voyagesofmodel: {
